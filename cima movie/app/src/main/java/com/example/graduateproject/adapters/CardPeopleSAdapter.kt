...
import com.example.graduateproject.databinding.PeopleCard2Binding
...
class CardPeopleSAdapter : RecyclerView.Adapter<CardPeopleSAdapter.VH>() {

    var people:ArrayList<ResultXX> = ArrayList()

    class VH(private var view: PeopleCard2Binding): RecyclerView.ViewHolder(view.root){
        ...
        companion object{
            ...
            {
                val view= PeopleCard2Binding.inflate(LayoutInflater.from(parent.context),parent,false)
